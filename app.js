...
//GETs
  ...
  app.get('/gerente/index', async (req, res) => {
    ...
    const chamadoConcluido = await carregarChamados.carregarChamadosConcluidos(idUsuario)
    
    res.render('index-gerente', { results: results, concluidos: chamadoConcluido })
  })
...
//POSTs
  ...
  app.post('/tecnico/finalizar-chamado', async (req, res) => {
    ...
    finalizarInformacoes.concluirChamado(idUsuario, req.body.id, dataFechamento, tempoDeRealizacao, req.body.relatorio)
    res.redirect('/tecnico/chamados')
  })
